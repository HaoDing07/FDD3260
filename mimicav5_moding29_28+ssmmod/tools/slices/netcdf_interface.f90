...
module netcdfmod
  ...
  character(len=10), dimension(nvarin) :: varlist=(/ 'U         ', 'V         ', 'W         ', 'PT        ', 'PTV       ', 'Qv        ', 'Qc        ', 'Qr        ', 'RH        ', 'Buoy      ', 'Beff      ', 'MSE       ', 'WVP       ',  'CT_height ', 'Pt_var    ', 'Qv_var    ', 'W_tend_1  ', 'W_tend_2  ', 'W_tend_3  ', 'W_tend_4  ', 'W_tend_5  ', 'W_tend_6  ', 'W_tend_7  ', 'W_tend_8  ', 'W_tend_9  ', 'QT_tend_1 ', 'QT_tend_2 ', 'QT_tend_3 ', 'QT_tend_4 ', 'QT_tend_5 ', 'QT_tend_6 ', 'QT_tend_7 ', 'QT_tend_8 ', 'QT_tend_9 ', 'PT_tend_1 ', 'PT_tend_2 ', 'PT_tend_3 ', 'PT_tend_4 ', 'PT_tend_5 ', 'PT_tend_6 ', 'PT_tend_7 ', 'PT_tend_8 ', 'PT_tend_9 ' /)
